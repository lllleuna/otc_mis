    ...
    <div class="container">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <p><strong>Letter of Intent:</strong> <a href="{{ asset('storage/' . $request->letter_of_intent) }}" target="_blank">Download</a></p>
        ...
        <form method="POST" action="{{ route('training.update', $request->id) }}">
            ...
            <div class="mb-3">
                ...
                <input type="datetime-local" name="training_date_time" class="form-control" value="{{ $request->training_date_time ? \Carbon\Carbon::parse($request->training_date_time)->format('Y-m-d\TH:i') : '' }}" required>
            </div>
