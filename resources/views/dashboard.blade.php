<x-layout>
        ...
        <div class="container mx-auto mt-10">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div class="flex space-x-6 mb-6">
                    <div class="w-1/3">
                        <label for="reportType" class="block text-sm font-semibold text-gray-700 mb-2">Report
                            Type</label>
                    ...
                    <div class="w-1/3">
                        ...
                        <label for="endDate" class="block text-sm font-semibold text-gray-700 mt-4 mb-2">End
                            Date</label>
                ...
                <div class="mt-4 flex justify-end">
                    ...
                    <button class="bg-yellow-500 text-white rounded-md p-2 ml-4 hover:bg-yellow-600">Send via
                        Email</button>
                </div>
            </div>
        </div>
    ...
    <footer class="bg-gray-800 text-white py-4 mt-10">
        <div class="container mx-auto text-center">
            ...
            <p><a href="/privacy-policy" class="text-blue-300 hover:text-blue-500">Privacy Policy</a> | <a
                    href="/terms-of-service" class="text-blue-300 hover:text-blue-500">Terms of Service</a></p>
        </div>
    </footer>
