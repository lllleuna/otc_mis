    ...
    <div class="space-y-3">
        ...
        <div class="pt-2">
            ...
            <a href="{{ asset('shared/uploads/' . basename($application->file_upload)) }}"
                class="inline-flex items-center px-4 py-2 text-sm font-medium rounded-md text-green-700 bg-green-50 hover:bg-green-100 border border-green-200 transition-colors"
                target="_blank">
        ...
        <div class="flex justify-between">
            ...
            <div class="mx-1">
                ...
                <input type="text" name="contact_no"
                    value="{{ old('contact_no', $appGenInfo->contact_no ?? '9000000000') }}" class="border p-2 rounded w-full"
...
@if (!empty($appUnits) && $appUnits->count())
    <div class="my-10">
        <h3 class="mt-10 text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">
            Units
        </h3>
...
@if (!empty($appFranchises) && $appFranchises->count())
    <div class="my-10">
        <h3 class="mt-10 text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">
            Franchise
        </h3>
...
@if (!empty($appLoans) && $appLoans->count())
    <div class="my-10">
        <h3 class="mt-10 text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">
            Loans
        </h3>
...
@if (!empty($appBusinesses) && $appBusinesses->count())
    <div class="my-10">
        <h3 class="mt-10 text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">
            Business
        </h3>
...
@if (!empty($appTrainings) && $appTrainings->count())
    <div class="my-10">
        <h3 class="mt-10 text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">
            Trainings/Seminar
        </h3>
...
@if (!empty($appAwards) && $appAwards->count())
    <div class="my-10">
        <h3 class="mt-10 text-lg font-semibold text-gray-800 mb-4 pb-2 border-b border-gray-200">
            Awards
        </h3>
