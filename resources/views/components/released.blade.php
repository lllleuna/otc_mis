    ...
    @if($application->maingeneralInfo)
        <div class="bg-gray-100 p-6 rounded-lg mb-6">
            ...
            <p class="mb-4 text-gray-700">Validity Date: 
                <span class="font-semibold text-blue-900">{{ \Carbon\Carbon::parse($application->maingeneralInfo->validity_date)->format('F d, Y') }}</span>
            </p>
            ...
            <div class="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8">
                ...
                <div class="flex-1">
                    ...
                    @if ($application->maingeneralInfo->accreditation_certificate_filename)
                        <a href="{{ asset('shared/certificates/' . $application->maingeneralInfo->accreditation_certificate_filename) }}" target="_blank" 
