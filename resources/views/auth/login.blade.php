                    ...
                    <div class="px-8 pb-8 pt-6">
                        <form action="{{ route('login') }}" method="POST" class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <button type="button" id="togglePassword"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" id="eyeOpen" class="h-5 w-5 text-gray-500"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" id="eyeClosed"
                            ...
                            <div class="text-center mt-4">
                                <a href="{{ route('reset-password') }}" class="text-blue-900 hover:underline">Forgot
                                    Password?</a>
                            </div>
                            <div class="pt-4">
                                <button type="submit"
                                    class="w-full bg-blue-900 text-white py-3 rounded-lg hover:bg-blue-800 transition">Login</button>
                            </div>
