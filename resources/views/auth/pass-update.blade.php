        ...
        <div class="bg-white rounded-lg shadow-xl overflow-hidden">
            ...
            <div class="px-8 pb-8 pt-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="new_password" id="new_password" placeholder="************" required class="w-full p-3 border rounded-lg focus:ring focus:ring-blue-300">
                    @error('new_password')
                ...
                <div class="mb-4">
                    ...
                    <input type="password" name="confirm_password" id="confirm_password" placeholder="************" required class="w-full p-3 border rounded-lg focus:ring focus:ring-blue-300">
