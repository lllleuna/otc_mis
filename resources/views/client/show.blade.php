                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <div class="flex items-center">
                                <span
                                    class="inline-flex items-center px-5 py-2 rounded-full text-sm font-medium {{ $isActive ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                    <span
                                        class="h-2 w-2 rounded-full {{ $isActive ? 'bg-green-500' : 'bg-red-500' }}"></span>
